...
from app.inventory.scemas import InventoryResponse, ItemToInventory
...
async def create_inventory(inventory: InventoryCreate, inventory_service: Annotated[InventoryService, Depends()]):
    """
...
async def get_inventories(inventory_service: Annotated[InventoryService, Depends()]):
    """
...
async def add_to_inventory(
    ...
    """
    return await inventory_service.add_to_inventory(item_to_inventory)


@router.get('/user_inventory', response_model=InventoryResponse)
async def get_user_inventory(inventory_service: Annotated[InventoryService, Depends()]):
    """
...
async def get_inventory_by_id(inventory_id: int, inventory_service: Annotated[InventoryService, Depends()]):
    """
